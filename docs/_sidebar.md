...
* Java
  * 1-运行你的第一个java程序
    ...
    * [1-2启动单文件源代码程序](/java/1/1-2启动单文件源码程序)
    * [1-3Jshell(Java Shell Tool)](/java/1/1-3Jshell)
  * 2-了解Java语言
    ...
    * 2-2Java语言基础知识
      ...
      * [2-2-5运算符](/java/2/2-2-5运算符)
      * [2-2-6表达式和语句和块](/java/2/2-2-6表达式和语句和块)
      * [2-2-7控制流语句](/java/2/2-2-7控制流语句)
      * [2-2-8使用Switch语句进行分支](/java/2/2-2-8使用Switch语句进行分支)
      * [2-2-9使用Switch表达式进行分支](/java/2/2-2-9使用Switch表达式进行分支)
    * [2-3使用记录建模不可变数据](/java/2/2-3使用Record为不可变数据建模)
    * 2-4类和对象
      * [2-4-1创建类](/java/2/2-4-1创建类)
      * [2-4-2定义方法](/java/2/2-4-2定义方法)
      * [2-4-3为类创建构造器](/java/2/2-4-3为类创建构造器)
      * [2-4-4调用方法和构造器](/java/2/2-4-4调用方法和构造器)
      * [2-4-5创建和使用对象](/java/2/2-4-5创建和使用对象)
    ...
    * 2-5数字和字符串
      * [2-5-1数字](/java/2/2-5-1数字)
      * [2-5-2字符](/java/2/2-5-2字符)
      * [2-5-3字符串](/java/2/2-5-3字符串)
      * [2-5-4字符串Builders](/java/2/2-5-4字符串Builders)
      * [2-5-5自动装箱和拆箱](/java/2/2-5-5自动装箱和拆箱)
    * 2-6继承
      * [2-6-1使用继承](/java/2/2-6-1使用继承)
      * [2-6-2重写和隐藏方法](/java/2/2-6-2重写和隐藏方法)
      * [2-6-3多态](/java/2/2-6-3多态)
      * [2-6-4Object超类](/java/2/2-6-4Object超类)
      * [2-6-5抽象的方法和类](/java/2/2-6-5抽象的方法和类)
    * 2-7接口
      * [2-7-1使用接口](/java/2/2-7-1使用接口)
      * [2-7-2接口实现](/java/2/2-7-2接口实现)
      * [2-7-3使用接口作为类型](/java/2/2-7-3使用接口作为类型)
    * 2-8泛型
      * [2-8-1介绍泛型](/java/2/2-8-1介绍泛型)
      * [2-8-2Type Inference](/java/2/2-8-2类型推理)
      * [2-8-3通配符](/java/2/2-8-3通配符)
      * [2-8-4Type Erasure](/java/2/2-8-4类型擦除)
      * [2-8-5使用泛型的限制](/java/2/2-8-5使用泛型的限制)
    * [2-10注解](/java/2/2-10注解)
    * [2-11包](/java/2/2-11包)
    * [2-12表达式匹配](/java/2/2-12表达式匹配)
    * 2-13异常
      * [2-13-1异常是什么](/java/2/2-13-1异常是什么)
      * [2-13-2捕获和处理异常](/java/2/2-13-2捕获和处理异常)
      * [2-13-3抛出异常](/java/2/2-13-1异常是什么)
      * [2-13-4Checked和Unchecked异常](/java/2/2-13-4Unchecked争议)
  * 3-需要熟悉掌握的API
    * [3-1集合框架]
      * [3-1-1了解集合层次结构](/java/3/3-1-1了解集合层次结构)
      * [3-1-2集合中存储元素](/java/3/3-1-2集合中存储元素)
      * [3-1-3迭代集合的元素](/java/3/3-1-3迭代集合的元素)
      * [3-1-4使用List扩展Collection](/java/3/3-1-4使用List扩展Collection)
      * [3-1-5使用Set,SortedSet和NavigableSet扩展Collection](/java/3/3-1-5使用Set,SortedSet和NavigableSet扩展Collection)
      * [3-1-6使用集合工厂方法创建和处理数据](/java/3/3-1-6使用集合工厂方法创建和处理数据)
      * [3-1-7在栈和队列中存储元素](/java/3/3-1-7在栈和队列中存储元素)
      * [3-1-8使用Maps存储键值对](/java/3/3-1-8使用Maps存储键值对)
      * [3-1-9管理Map内容](/java/3/3-1-9管理Map内容)
      * [3-1-10为您的key选择不可变类型](/java/3/3-1-10为您的key选择不可变类型)
    * 3-2Stream Api-待续
  * 4-组织你的程序
    * 4-1模块-待续
    * 4-2使用JLink创建运行时和应用程序映像-待续
  * 5-了解Jvm
    * 5-1核心JDK工具
      * [5-1-1介绍JDK的核心工具](/java/5/5-1JDK核心工具/5-1-1介绍JDK的核心工具)
      * [5-1-2Javac编译器](/java/5/5-1JDK核心工具/5-1-2Javac编译器)
      * [5-1-3Javap-反汇编程序](/java/5/5-1JDK核心工具/5-1-3Javap-反汇编程序)
      * [5-1-4Javadoc文档生成器](/java/5/5-1JDK核心工具/5-1-4Javadoc文档生成器)
    * 5-2监控工具
      * [5-2-1Jconsole](/java/5/5-2监控工具/5-2-1JConsole)
      * [5-2-2Jps](/java/5/5-2监控工具/5-2-2Jps)
      * [5-2-3Jstat](/java/5/5-2监控工具/5-2-3Jstat)
      * [5-2-4Jstatd](/java/5/5-2监控工具/5-2-4Jstatd)
    * 5-3故障诊断工具
      * [5-3-1-Jcmd](/java/5/5-3故障诊断工具/5-3-1-Jcmd)
      * [5-3-2Jdb](/java/5/5-3故障诊断工具/5-3-2Jdb)
      * [5-3-3Jhsdb](/java/5/5-3故障诊断工具/5-3-3Jhsdb)
      * [5-3-4Jinfo](/java/5/5-3故障诊断工具/5-3-4Jinfo)
      * [5-3-5Jmap](/java/5/5-3故障诊断工具/5-3-5Jmap)
      * [5-3-6Jstack](/java/5/5-3故障诊断工具/5-3-6Jstack)
    * 5-4垃圾回收器
      * [5-4-1垃圾回收简介](/java/5/5-4垃圾回收器/5-4-1垃圾回收简介)
      * [5-4-2Java中的垃圾回收](/java/5/5-4垃圾回收器/5-4-2Java中的垃圾回收)
    * 5-5其他笔记
